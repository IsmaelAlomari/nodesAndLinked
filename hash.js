...
class HashTable {
    ...
    insert = (student) => {
       ...
       else console.log("you are under level of this class or go to another school")
    }
...
const size = prompt("size of class :")
const newTable = new HashTable(size)

students.map (student => newTable.insert(student))
